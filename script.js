const arr=[
    ...
    arr.forEach(function(val)
    {
        ...
        //creating div which having all the details 
        //img name actor or and soon
        let div=document.createElement('div')
        div.classList.add('name')
        maindiv.appendChild(div)
        let fchild=document.createElement('div')
        let schild=document.createElement('div')
        div.appendChild(fchild)
        fchild.classList.add('first')
        div.appendChild(schild)
        schild.classList.add('second')

        // creating image 
        let img=document.createElement('img')
        img.src=val.Images
        fchild.appendChild(img)
    // adding  extra infotmation
    let nm=document.createElement('h2')
    // movie name
    nm.textContent=val.Title
    schild.appendChild(nm)
    let dt=document.createElement('p')
    dt.innerHTML="<strong> Duration : </strong>  "+val.Runtime
    schild.appendChild(dt)
    let post=document.createElement('a')
  
    post.href=val.Poster
div.appendChild(post)       
let Genr=document.createElement('p')
Genr.innerHTML="<strong>Genr : </strong>"  + val.Genre
schild.appendChild(Genr) 
let lng=document.createElement('p')
lng.innerHTML="<strong>Language : </strong>"+val.Language
schild.appendChild(lng)
let anchor=document.createElement('a')
anchor.href="https://media.netflix.com/en/"
// anchor.appendChild)
img.title=val.Title
  })